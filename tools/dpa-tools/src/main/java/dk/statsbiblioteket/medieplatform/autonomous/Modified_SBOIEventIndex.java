 ...
 *
 * NOTE: COULD NOT BE SUB-CLASSED AS summaSearch was private :-/
 */
public class Modified_SBOIEventIndex<T extends Item> implements EventTrigger<T> {
    ...
    private static Logger log = org.slf4j.LoggerFactory.getLogger(Modified_SBOIEventIndex.class);
    ...
    public Modified_SBOIEventIndex(String summaLocation, PremisManipulatorFactory<T> premisManipulatorFactory,
    ...
    public Iterator<T> search(boolean details, Query<T> query) throws CommunicationException {
       return new Modified_SolrProxyIterator<>(toQueryString(query),details,summaSearch,premisManipulatorFactory,domsEventStorage,pageSize);
    }
