...
/**
 * This class is a work around that we may need to ask questions that EventTrigger.Query could not do and
 * the important calling routine is in a maven artifact outside of this project.
