 ...
 */
public class Modified_SolrProxyIterator<T extends Item> implements Iterator<T> {
    private static Logger log = org.slf4j.LoggerFactory.getLogger(Modified_SolrProxyIterator.class);
     ...
     */
    public Modified_SolrProxyIterator(String queryString, boolean details, HttpSolrServer summaSearch,
     ...
     * @return next hit
     * @throws NoSuchElementException if no more cached hits and no more hits in sboi.
     */
    @Override
