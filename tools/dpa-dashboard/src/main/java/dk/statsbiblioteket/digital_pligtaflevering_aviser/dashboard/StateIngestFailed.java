...
public class StateIngestFailed extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<DomsItem> l = repository.query(new SBOIQuerySpecification(SBOIConstants.Q_INGEST_FAILED))
                .collect(Collectors.toList());
        
        request.setAttribute("l", l);
        request.setAttribute("h", "Ingest Failed");
